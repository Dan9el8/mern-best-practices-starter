...
Nex.js application is displaying data about family guys charactersApplication Preview
...
Boilerplate's initial pageBoilerplate's initial page
...
Preview of the sticky navigation barPreview of the sticky navigation bar
...
JSON data in the browserJSON data in the browser
...
App's homepage is displaying a list of family guy charactersHomepage
...
Family Guy application with dynamic routesOur application so far
...
An introduction page for the family guy quiz sectionQuiz introduction page
...
Imagehttp://localhost:3000/api/quiz/CfQnf3lH56
...
Next.js UI route which displays the dynamic questionQuestion UI route
...
Quiz final versionQuiz final version
